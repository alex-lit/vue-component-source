(function (t, e) {
  'object' === typeof exports && 'object' === typeof module
    ...
    ? (exports['vue-component-source'] = e())
    : (t['vue-component-source'] = e());
  ...
  return (function (t) {
    ...
    '4caa': function (t, e, n) {
      var r = n('a919'),
        ...
        l = RegExp(d, 'g');
      function s(t) {
        return (t = o(t)), t && t.replace(u, r).replace(l, '');
      }
      t.exports = s;
    },
    '585a': function (t, e, n) {
    ...
    8875: function (t, e, n) {
      ...
      (function (n, i) {
        (o = []),
          (r = i),
          (u = 'function' === typeof r ? r.apply(e, o) : r),
        ...
        function t() {
          ...
          try {
            ...
            var n,
              ...
              u = /.*at [^(]*\((.*):(.+):(.+)\)$/gi,
              i = /@([^@]*):(\d+):(\d+)\s*$/gi,
              c = u.exec(p.stack) || i.exec(p.stack),
              f = (c && c[1]) || !1,
              a = (c && c[2]) || !1,
            ...
            for (var s = 0; s < l.length; s++) {
              if ('interactive' === l[s].readyState) return l[s];
              if (l[s].src === f) return l[s];
              if (f === d && l[s].innerHTML && l[s].innerHTML.trim() === o)
                return l[s];
            }
            return null;
          }
    ...
    ea72: function (t, e, n) {
      ...
      function c(t, e, n) {
        return (
          (t = u(t)),
          (e = n ? void 0 : e),
          void 0 === e ? (o(t) ? i(t) : r(t)) : t.match(e) || []
        );
      }
      t.exports = c;
    },
            ...
            if (this.$el && n.enabled) {
              var i = d(
                f()(
                  null ===
                    (e =
                      null === (t = this.$vnode) || void 0 === t
                        ? void 0
                        : t.componentOptions) || void 0 === e
                    ? void 0
                    : e.tag,
                ),
                null ===
                  (u =
                    null ===
                      (o =
                        null === (r = this.$vnode) || void 0 === r
                          ? void 0
                          : r.componentInstance) || void 0 === o
                      ? void 0
                      : o.$options) || void 0 === u
                  ? void 0
                  : u.__file,
              ...
              i.startComment &&
                i.endComment &&
                ((this.$$COMMENT = {
                  START: document.createComment(' ' + i.startComment + ' '),
                  END: document.createComment(' ' + i.endComment + ' '),
                }),
